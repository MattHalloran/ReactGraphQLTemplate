    ...
    return (
        <div id="page">
            ...
            <ul>
                ...
                <li>
                    <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to {BUSINESS_NAME.Long}, {ADDRESS.Label}.</p>
                </li>
                <li>
                ...
                <li>
                    <p><strong>Website</strong> refers to {BUSINESS_NAME.Long}, accessible from <a href="https://newlifenurseryinc.com" rel="external nofollow noopener">https://newlifenurseryinc.com</a></p>
                </li>
                <li>
            ...
            <p>{BUSINESS_NAME.Long} and the customer have entered into an agreement for the provision of Processor Services. If you are accepting these Data Processing Terms, you warrant that: (a) you have full legal authority to bind to these Data Processing Terms; (b) you have read and understand these Data Processing Terms; and (c) you agree to these Data Processing Terms.</p>
            ...
            <ul>
                ...
                <ul>
                    ...
                    <ul>
                        <li>{BUSINESS_NAME.Long} is a processor of Customer Personal Data under the European Data Protection Legislation</li>
                    ...
                    <li><strong>Authorization by Third Party Controller</strong>. If the customer is a processor, the customer warrants to {BUSINESS_NAME.Long} that the customer's instructions and actions with respect to Customer Personal Data, including its appointment of {BUSINESS_NAME.Long} as another processor, have been authorized by the relevant controller.</li>
                </ul>
                <li><strong>Customer's Instructions</strong>. By entering into these Data Processing Terms, Customer instructs {BUSINESS_NAME.Long} to process Customer Personal Data only in accordance with applicable law.</li>
                <li><strong>{BUSINESS_NAME.Long}'s Compliance with Instructions</strong>. {BUSINESS_NAME.Long} will comply with the instructions described in Customer's Instructions, unless European or National Laws to which {BUSINESS_NAME.Long} is subject require other processing of Customer Personal Data by {BUSINESS_NAME.Long}, in which case {BUSINESS_NAME.Long} will inform the customer (unless any such law prohibits {BUSINESS_NAME.Long} from doing so on important grounds of public interest).</li>
                ...
                <li><strong>Deletion During Term</strong>
                    <ul>
                        ...
                        <ul>
                            ...
                            <p>then {BUSINESS_NAME.Long} will delete such Customer Personal Data from its systems as soon as reasonably practicable and within a maximum period of 180 days, unless European or National Laws require storage.</p>
                        </li>
                        <li><strong>Processor Services Without Deletion Functionality</strong>. During the Term, if the functionality of the Processor Services does not include the option for Customer to delete Customer Personal Data, then {BUSINESS_NAME.Long} will comply with:
                        <ul>
                    ...
                    <p>{BUSINESS_NAME.Long} may charge a fee (based on {BUSINESS_NAME.Long}'s reasonable costs) for any data deletion under this section. Ne Life Nursery will provide Customer with further details of any applicable fee, and the basis of its calculation, in advance of any such data deletion</p>

                </li>
                <li><strong>Deletion on Term Expirty</strong>. On expiry of the Term, Customer instructs {BUSINESS_NAME.Long} to delete all Customer Personal Data (including existing copies) from {BUSINESS_NAME.Long}'s systems in accordance with applicable law.  will comply with this instruction as soon as reasonably practicable and within a maximum period of 180 days, unless European or National Laws require storage.</li>
            ...
            <p>This Privacy Policy is designed to help you understand how {BUSINESS_NAME.Long} handles your information:</p>
            <ul>
                <li>We explain the categories of information {BUSINESS_NAME.Long} collects and the sources of that information</li>
                <li>We explain how {BUSINESS_NAME.Long} uses information</li>
                <li>We explain when {BUSINESS_NAME.Long} may share information</li>
            </ul>
            <p>The CCPA also provides the right to request information about how {BUSINESS_NAME.Long} collects, uses, and discloses your personal information. And it gives you the right to access your information and request that {BUSINESS_NAME.Long} delete that information. Finally, the CCPA provides the right to not be discriminated against for exercising your privacy rights</p>
            <p>We describe the choices you have to manage your privacy and data across {BUSINESS_NAME.Long}'s services</p>
            ...
            <ul>
                <li><strong>Protecting against security threats, abuse, and illegal activity</strong>: {BUSINESS_NAME.Long} may disclose information to detect, prevent, and respond to security incidents, and for protecting against other malicious, deceptive, fraudulent, or illegal activity.</li>
                <li><strong>Auditing and measurement</strong>: {BUSINESS_NAME.Long} uses information for analytics and measurement to understand how our services are used, as well as to fulfill obligations to our partners like advertisers, developers, or rights holders. We may disclose non-personally identifiable information publicly and with these partners, including for auditing purposes</li>
                <li><strong>Maintaining our services</strong>: {BUSINESS_NAME.Long} uses information to ensure our services are working as intended, such as tracking outages or troubleshooting bugs and others issues that you report to us.</li>
                <li><strong>Research and development</strong>: {BUSINESS_NAME.Long} uses information to improve our services and to develop new products, features, and technologies that benefit our users and the public</li>
                <li><strong>Use of service providers</strong>: {BUSINESS_NAME.Long} may share information with service providers to perform services on our behalf, in compliance with our Privacy Policy and other appropriate confidentiality and security measures.</li>
                <li><strong>Legal reasons</strong>: {BUSINESS_NAME.Long} also uses information to satisfy applicable laws or regulations, and discloses information in response to legal process or enforceable government requests, including to law enforcement.</li>
            </ul>
            ...
            <ul>
                ...
                <li><strong>Service providers</strong>, trusted businesses or persons that process information on {BUSINESS_NAME.Long}'s behalf, based on our instructinos and in compliance with our Privacy Policy and any other appropriate confidentiality and security measures</li>
            ...
            <ul>
                ...
                <li>Services offered by other companies or individuals, including products or sites that may include {BUSINESS_NAME.Long} services, be displayed to you in search results, or be linked from our services.</li>
            </ul>
            ...
            <ul>
                <li>
                    <p>By email: <a href={EMAIL.Link}>{EMAIL.Label}</a></p>
                </li>
                <li>
                ...
                <li>
                    <p>By phone number: <a href={PHONE.Link}>{PHONE.Label}</a></p>
                </li>
            </ul>
