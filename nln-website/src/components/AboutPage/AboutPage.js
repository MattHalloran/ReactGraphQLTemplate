    ...
    render() {
        return (
            <div>
                ...
                <br/>
                <h3>For over thirty-five years now, New Life Nursery, Inc has been striving to grow the most beautiful, healthy and consistent plant material at competitive prices. Still family owned and operated by the Gianaris Family, we continue to hold to our original motto."Growing top quality material for buyers who are interested in the best".

As wholesale growers, we are always looking ahead to the next season with anticipation for something new. In addition to the wonderful trees and shrubs you have come to expect from New Life Nursery, Inc over the years, we look forward to offering many new varieties as we head into each new season. Feel free to contact us for access to our updated availability list. As always, we encourage our customers to send us their comments and suggestions.
